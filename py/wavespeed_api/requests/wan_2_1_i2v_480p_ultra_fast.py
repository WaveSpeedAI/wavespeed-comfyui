...
# link api json(wan-2.1-i2v-480p-ultra-fast.json)
class Wan21I2v480pUltraFast(BaseRequest):
    """
    Request model for the Wan 2.1 I2V 480p Ultra Fast API.
    ...
    def build_payload(self) -> dict:
        ...
        # API JSON does not contain loras, so no normalization needed here.
