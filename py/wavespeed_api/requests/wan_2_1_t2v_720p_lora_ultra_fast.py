...
# link api json(wan-2.1-t2v-720p-lora-ultra-fast.json)
class Wan2x1T2v720pLoraUltraFast(BaseRequest):
    """
    Request model for the Wan 2.1 T2V 720p LoRA Ultra Fast API.

    Turbo-charged inference for Wan 2.1 14B. Unleashing high-res 720p text-to-video prowess 
    ...
    def get_api_path(self):
        ...
        return "/api/v2/wavespeed-ai/wan-2.1/t2v-720p-lora-ultra-fast"
