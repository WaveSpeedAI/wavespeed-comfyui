...
# link api json(wan-2.1-i2v-480p-lora.json)
class Wan2x1I2V480pLora(BaseRequest):
    """
    ...
    enable_safety_checker: Optional[bool] = Field(True, description="Whether to enable the safety checker.")  # disabled: true in json, but example has it as True
    ...
    def get_api_path(self):
        ...
        return "/api/v2/wavespeed-ai/wan-2.1/i2v-480p-lora"
